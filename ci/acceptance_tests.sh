...
export JRUBY_OPTS="-J-Xmx1g -J--add-opens=java.base/javax.crypto=ALL-UNNAMED -J--add-opens=java.base/java.security=ALL-UNNAMED -J--add-opens=java.base/sun.nio.ch=ALL-UNNAMED -J--add-opens=java.base/java.io=ALL-UNNAMED  -J--add-opens=java.base/java.security.cert=ALL-UNNAMED"
export GRADLE_OPTS="-Xmx4g -Dorg.gradle.daemon=false -Dorg.gradle.logging.level=info -Dfile.encoding=UTF-8 --add-opens=java.base/javax.crypto=ALL-UNNAMED --add-opens=java.base/java.security=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED  --add-opens=java.base/java.security.cert=ALL-UNNAMED"
export OSS=true
